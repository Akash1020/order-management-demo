 ...
 *
 */
public class UsersByVendorProduct {
	...
	public String toString() {
		return "UsersByVendorProduct [vendor=" + vendor + ",userId="
				+ userId + ", firstname=" + firstname + ", middlename="
				+ middlename + ", lastname=" + lastname + ", dob=" + dob
